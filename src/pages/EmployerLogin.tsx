...
export default function EmployerLoginPortal() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900">
      {/* Navigation */}
      <nav className="bg-gray-900/90 shadow-2xl sticky top-0 z-50 backdrop-blur-xl border-b border-purple-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <div className="bg-gradient-to-r from-purple-500 to-violet-500 p-2 rounded-xl shadow-lg shadow-purple-500/50">
                <Briefcase className="w-6 h-6 text-white" />
              </div>
              <div>
                ...
                <p className="text-xs text-purple-300">Employer Portal</p>
              </div>
            </div>

            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-purple-100 hover:text-purple-300 transition-colors font-medium">Features</a>
              <a href="#contact" className="text-purple-100 hover:text-purple-300 transition-colors font-medium">Contact</a>
            </div>

            <button
              onClick={() => setIsMenuOpen(!isMenuOpen)}
              className="md:hidden p-2 rounded-lg hover:bg-gray-800 transition-colors text-purple-400"
            >
              {isMenuOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
            </button>
          </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 space-y-3 animate-fade-in">
              <a href="#features" className="block px-4 py-2 text-purple-100 hover:bg-gray-800 rounded-lg transition-colors">Features</a>
              <a href="#contact" className="block px-4 py-2 text-purple-100 hover:bg-gray-800 rounded-lg transition-colors">Contact</a>
            </div>
          )}
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="text-center mb-8 md:mb-12 animate-fade-in">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Welcome to <span className="bg-gradient-to-r from-purple-400 via-violet-400 to-fuchsia-400 bg-clip-text text-transparent">Employer Portal</span>
          </h2>
          <p className="text-lg md:text-xl text-purple-100 max-w-3xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 md:mb-12">
          {stats.map((stat, index) => (
            <div key={index} className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-start">
          {/* Login/Signup Section */}
          <div className="bg-gray-800/60 backdrop-blur-xl rounded-3xl shadow-2xl p-6 md:p-8 border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300">
            <div className="flex justify-center mb-6">
              <div className="bg-gray-700/50 rounded-full p-1 inline-flex">
                <button
                  onClick={() => setIsLogin(true)}
                  className={`px-4 md:px-6 py-2 rounded-full transition-all duration-300 text-sm md:text-base font-medium ${
                    isLogin ? 'bg-gradient-to-r from-purple-500 to-violet-500 text-white shadow-lg shadow-purple-500/50' : 'text-purple-300 hover:text-purple-100'
                  }`}
                >
                  Login
                </button>
            ...
            <div className="space-y-4 md:space-y-5">
              {!isLogin && (
                <>
                  <div className="transform transition-all duration-300">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={formData.companyName}
                        onChange={(e) => setFormData({...formData, companyName: e.target.value})}
                        className="w-full pl-10 pr-4 py-3 bg-gray-700/50 border border-purple-500/30 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-white placeholder-purple-300/50"
                        placeholder="Your Company Name"
                      />
                    </div>
                  </div>
                  ...
                  <div className="transform transition-all duration-300">
                    <label className="block text-sm font-medium text-purple-200 mb-2">Contact Person</label>
                    <div className="relative">
              ...
              <div className="transform transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.password}
                    onChange={(e) => setFormData({...formData, password: e.target.value})}
                    className="w-full pl-10 pr-12 py-3 bg-gray-700/50 border border-purple-500/30 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-white placeholder-purple-300/50"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              {isLogin && (
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm space-y-2 sm:space-y-0">
                  <label className="flex items-center">
                    <input type="checkbox" className="rounded border-purple-500/30 bg-gray-700/50 text-purple-500 focus:ring-purple-500" />
              ...
              <button
                onClick={handleSubmit}
                className="w-full bg-gradient-to-r from-purple-500 via-violet-500 to-fuchsia-500 text-white py-3 rounded-xl font-semibold hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center group"
              >
                {isLogin ? 'Sign In' : 'Create Account'}
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
          ...
          {/* Features Overview */}
          <div className="space-y-6">
            <div className="bg-gray-800/60 backdrop-blur-xl rounded-3xl shadow-2xl p-6 md:p-8 border border-purple-500/30">
              ...
              <div className="space-y-4">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-700/50 transition-all duration-300 transform hover:translate-x-2 cursor-pointer group border border-transparent hover:border-purple-500/30"
                  >
                    <div className="bg-gradient-to-r from-purple-500 to-violet-500 p-3 rounded-xl text-white group-hover:shadow-lg group-hover:shadow-purple-500/50 transition-shadow flex-shrink-0">
                      {feature.icon}
                    </div>
            ...
            <div className="bg-gradient-to-br from-purple-600 via-violet-600 to-fuchsia-600 rounded-3xl shadow-2xl p-6 md:p-8 text-white">
        ...
        <div id="features" className="mt-12 md:mt-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-gray-800/60 backdrop-blur-xl rounded-3xl shadow-lg p-6 transform transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-2 group border border-purple-500/30 hover:border-purple-400/50"
              >
                <div className="bg-gradient-to-r from-purple-500 to-violet-500 w-16 h-16 rounded-2xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-purple-500/50">
                  {feature.icon}
                </div>
                <h3 className="text-lg md:text-xl font-bold text-white mb-4">{feature.title}</h3>
                <ul className="space-y-2">
                  {feature.points.map((point, idx) => (
                    <li key={idx} className="flex items-start space-x-2 text-sm text-purple-200">
        ...
        {/* Contact Section */}
        <div id="contact" className="mt-12 md:mt-20 bg-gradient-to-r from-purple-600 via-violet-600 to-fuchsia-600 rounded-3xl shadow-2xl p-6 md:p-12 text-white">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-purple-600 px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                Schedule a Demo
              </button>
              <button className="bg-transparent border-2 border-white text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-105">
                Contact Sales
              </button>
            </div>
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              <div>
                <Mail className="w-6 h-6 mx-auto mb-2" />
                <p className="text-sm text-purple-100">partners@campusconnect.edu</p>
              </div>
              <div>
                <Phone className="w-6 h-6 mx-auto mb-2" />
                <p className="text-sm text-purple-100">+91 1800-123-4567</p>
              </div>
              <div>
                <MapPin className="w-6 h-6 mx-auto mb-2" />
                <p className="text-sm text-purple-100">Support: 24/7 Available</p>
              </div>
            </div>
          </div>
        </div>
